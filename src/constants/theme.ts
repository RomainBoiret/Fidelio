...
export const Colors = {
  light: {
    ...
    accentSecondarySoft: 'rgba(155, 124, 255, 0.12)',
    cardAlt: '#3D3480',
    success: '#2FAE7A',
    danger: '#E25555',
    overlay: 'rgba(20, 18, 42, 0.48)',
    barcodeBg: '#FFFFFF',
    shadow: 'rgba(42, 37, 96, 0.12)',
    blobA: 'rgba(91, 108, 255, 0.16)',
    blobB: 'rgba(155, 124, 255, 0.12)',
    blobC: 'rgba(42, 37, 96, 0.08)',
  },
  dark: {
    text: '#F4F3FA',
    ...
    accentSecondarySoft: 'rgba(183, 156, 255, 0.14)',
    cardAlt: '#252048',
    success: '#4ADE9B',
    danger: '#FF7B7B',
    ...
    blobA: 'rgba(139, 155, 255, 0.12)',
    blobB: 'rgba(183, 156, 255, 0.1)',
    blobC: 'rgba(244, 243, 250, 0.04)',
  },
} as const;
